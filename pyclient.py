...
while not shutdownClient:
    ...
    while True:
        ...
        if buf != None and str(buf).find('***shutdown***') >= 0:
            ...
            d.table.to_csv(path_or_buf="C:/Users/USER/Desktop/Torcs---Reinforcement-Learning-using-Q-Learning-master/Qtable.csv",index=False)
        ...
        if buf != None and str(buf).find('***restart***') >= 0:
            ...
            d.table.to_csv(path_or_buf="C:/Users/USER/Desktop/Torcs---Reinforcement-Learning-using-Q-Learning-master/Qtable.csv",index=False)
            f=open("C:/Users/USER/Desktop/Torcs---Reinforcement-Learning-using-Q-Learning-master/episode.txt","r")
            x=int(f.read())+1
            f.close()
            f=open("C:/Users/USER/Desktop/Torcs---Reinforcement-Learning-using-Q-Learning-master/episode.txt","w")
            f.write(str(x))
            f.close()
            print("Episod number = "+str(x))
            exec(open('pyclient.py').read())  #Do After first iteration
